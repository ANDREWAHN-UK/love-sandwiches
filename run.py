...
def calculate_surplus_data(sales_row):
    ...
    Negative surplus = sandwiches needed to be made as stock run out
    """
...
def update_worksheet(data, worksheet):
    """
    Receives a list of integers to be inserted into a worksheet and updates the relevant worksheet
    """
...
def get_last_five_entries_sales():
    """
    Collects the data for the last 5 sales days of each sandwich and returns 
    them as a list of lists, and in columns
    """
